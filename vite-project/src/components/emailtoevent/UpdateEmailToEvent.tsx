...
export const UpdateEmailToEvent = () => {
    const {emailtoeventid} = useParams();
    const navigate = useNavigate();

    const [emailToEvent, setEmailToEvent] = useState({
        id: (typeof emailtoeventid === "string" ? parseInt(emailtoeventid) : -1),
        name: "",
        details: "",
        email: 0,
        event: 0,
    ...
    const updateEmail = async (event: { preventDefault: () => void }) => {
            ...
            try {
                await axios.patch(`${BACKEND_API_URL}/emailtoevent/?id=${emailtoeventid}`, emailToEvent, {
                    headers: {
            ...
            <Card>
                <CardContent>
                    ...
                    <form onSubmit={updateEmail}>
                        ...
                        <Button type="submit">Update Email To Event</Button>
                    </form>
                </CardContent>
